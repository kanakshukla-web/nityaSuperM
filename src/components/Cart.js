...
export default function Cart({ cart }) {
  ...
  return (
    <div className="cart-layout" style={{ width: '80%', margin: '0 auto' }}>
      <div>
        <h1>Your Cart</h1>
        {cart.length === 0 && (
        ...
        {cart.length > 0 && (
          <>
            ...
            <form className="pay-form" onSubmit={handleFormSubmit}>
              ...
              <div>
                <Input
                  style={{ border: '1px solid grey', width: '30%' }}
                  placeholder="Email"
                  ...
                  required
                />
                <Button className='btn btn-primary' style={{ width: '30%' }} type="submit">Pay</Button>
              </div>
            </form>
          </>
        )}
